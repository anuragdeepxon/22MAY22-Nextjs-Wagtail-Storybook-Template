...
function CheckoutSuccess({ navigation, products }) {
    const Layout = CheckoutSuccess.Layout;
    return (
            ...
            <div className="bg-white">
                <div className="max-w-3xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                    <div className="max-w-xl">
                        ...
                        <p className="mt-2 text-base text-gray-500">Your order #14034056 has been placed and will be with you soon.</p>
...
CheckoutSuccess.Layout = DefaultLayout;
